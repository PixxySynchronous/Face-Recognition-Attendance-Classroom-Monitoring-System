...
try:
    ...
    print("[combined] warning: dlib not available; cognitive landmark features disabled.\n"
          "Install dlib (requires CMake & a C++ build toolchain) for full functionality.")
import numpy as np
    ...
    def __init__(
        ...
        if DLIB_AVAILABLE:
            ...
            try:
                ...
                print("  [combined] warning: failed to load dlib shape predictor; disabling landmark features.")
        else:
            self._predictor = None
                            ...
                            if head_crop.size > 0:
                                ...
                                if faces:
                                    ...
                                    if fx2 > fx1 and fy2 > fy1:
                                        # dlib-based landmarks and derived signals (if available)
                                        if DLIB_AVAILABLE and self._predictor is not None:
                                            ...
                                            # dlib not available; skip landmark-derived signals
                                            face_ear = None
                                            face_gaze = None
                                            face_pitch = 0.0
                                            face_mar = 0.0
